...
class _CardShareComponentState extends State<CardShareComponent> {
  ...
  List<MemberClass1> cardList = [];
  MemberClass1 _memberClass;
  bool isLoading = true;
  ...
  _getAllCards() async {
    try {
      ...
      Future res = Services.CardIdNight(prefs.getString(cnst.Session.Mobile));
      setState(() {
        isLoading = true;
      });
      res.then((data) async {
